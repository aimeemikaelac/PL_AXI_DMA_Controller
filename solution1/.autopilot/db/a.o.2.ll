...
@.str = private unnamed_addr constant [8 x i8] c"ap_none\00", align 1 ; [#uses=12 type=[8 x i8]*]
...
; [#uses=0]
define void @pl_axi_dma_controller(i32* %AXI_DMA_SLAVE, i32 %startAddress, i1 zeroext %write, i32 %length, i32 %iterations, i1 zeroext %enabled, i1* %reset_scanner, i32* %dma_control, i32* %dma_status, i32* %dma_address, i1* %fabric_interrupt_write_finished.V, i1* %fabric_interrupt_read_finished.V, i1* %controller_finished.V) {
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %AXI_DMA_SLAVE), !map !1579
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %startAddress), !map !1585
  call void (...)* @_ssdm_op_SpecBitsMap(i1 %write), !map !1591
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %length), !map !1595
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %iterations), !map !1599
  call void (...)* @_ssdm_op_SpecBitsMap(i1 %enabled), !map !1603
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %reset_scanner), !map !1607
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %dma_control), !map !1611
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %dma_status), !map !1615
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %dma_address), !map !1619
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %fabric_interrupt_write_finished.V), !map !1623
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %fabric_interrupt_read_finished.V), !map !1627
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %controller_finished.V), !map !1631
  call void (...)* @_ssdm_op_SpecTopModule([22 x i8]* @str) nounwind
  %startAddress.assign = alloca i32, align 4      ; [#uses=3 type=i32*]
  %write.assign = alloca i1, align 1              ; [#uses=2 type=i1*]
  %length.assign = alloca i32, align 4            ; [#uses=3 type=i32*]
  %iterations.assign = alloca i32, align 4        ; [#uses=2 type=i32*]
  %enabled.assign = alloca i1, align 1            ; [#uses=2 type=i1*]
  call void @llvm.dbg.value(metadata !{i32* %AXI_DMA_SLAVE}, i64 0, metadata !1635), !dbg !1636 ; [debug line = 4:51] [debug variable = AXI_DMA_SLAVE]
  call void @llvm.dbg.value(metadata !{i32 %startAddress}, i64 0, metadata !1637), !dbg !1638 ; [debug line = 4:84] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32 %startAddress}, i64 0, metadata !1637), !dbg !1638 ; [debug line = 4:84] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32 %startAddress}, i64 0, metadata !1637), !dbg !1638 ; [debug line = 4:84] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32 %startAddress}, i64 0, metadata !1637), !dbg !1638 ; [debug line = 4:84] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32 %startAddress}, i64 0, metadata !1637), !dbg !1638 ; [debug line = 4:84] [debug variable = startAddress]
  ...
  call void @llvm.dbg.value(metadata !{i1 %write}, i64 0, metadata !1639), !dbg !1640 ; [debug line = 4:112] [debug variable = write]
  store volatile i1 %write, i1* %write.assign, align 1
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !1641), !dbg !1642 ; [debug line = 4:132] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !1641), !dbg !1642 ; [debug line = 4:132] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !1641), !dbg !1642 ; [debug line = 4:132] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !1641), !dbg !1642 ; [debug line = 4:132] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32 %length}, i64 0, metadata !1641), !dbg !1642 ; [debug line = 4:132] [debug variable = length]
  ...
  call void @llvm.dbg.value(metadata !{i32 %iterations}, i64 0, metadata !1643), !dbg !1644 ; [debug line = 5:16] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32 %iterations}, i64 0, metadata !1643), !dbg !1644 ; [debug line = 5:16] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32 %iterations}, i64 0, metadata !1643), !dbg !1644 ; [debug line = 5:16] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32 %iterations}, i64 0, metadata !1643), !dbg !1644 ; [debug line = 5:16] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32 %iterations}, i64 0, metadata !1643), !dbg !1644 ; [debug line = 5:16] [debug variable = iterations]
  ...
  call void @llvm.dbg.value(metadata !{i1 %enabled}, i64 0, metadata !1645), !dbg !1646 ; [debug line = 5:42] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1 %enabled}, i64 0, metadata !1645), !dbg !1646 ; [debug line = 5:42] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1 %enabled}, i64 0, metadata !1645), !dbg !1646 ; [debug line = 5:42] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1 %enabled}, i64 0, metadata !1645), !dbg !1646 ; [debug line = 5:42] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1 %enabled}, i64 0, metadata !1645), !dbg !1646 ; [debug line = 5:42] [debug variable = enabled]
  ...
  call void @llvm.dbg.value(metadata !{i1* %reset_scanner}, i64 0, metadata !1647), !dbg !1648 ; [debug line = 5:66] [debug variable = reset_scanner]
  call void @llvm.dbg.value(metadata !{i32* %dma_control}, i64 0, metadata !1649), !dbg !1650 ; [debug line = 6:17] [debug variable = dma_control]
  call void @llvm.dbg.value(metadata !{i32* %dma_status}, i64 0, metadata !1651), !dbg !1652 ; [debug line = 6:44] [debug variable = dma_status]
  call void @llvm.dbg.value(metadata !{i32* %dma_address}, i64 0, metadata !1653), !dbg !1654 ; [debug line = 6:70] [debug variable = dma_address]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_write_finished.V}, i64 0, metadata !1655), !dbg !1664 ; [debug line = 7:24] [debug variable = fabric_interrupt_write_finished.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_read_finished.V}, i64 0, metadata !1665), !dbg !1667 ; [debug line = 7:78] [debug variable = fabric_interrupt_read_finished.V]
  call void @llvm.dbg.value(metadata !{i1* %controller_finished.V}, i64 0, metadata !1668), !dbg !1670 ; [debug line = 7:131] [debug variable = controller_finished.V]
  call void @llvm.dbg.value(metadata !{i1* %controller_finished.V}, i64 0, metadata !1671), !dbg !1673 ; [debug line = 46:117@7:152] [debug variable = controller_finished.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_read_finished.V}, i64 0, metadata !1676), !dbg !1678 ; [debug line = 28:128@7:0] [debug variable = fabric_interrupt_read_finished.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_write_finished.V}, i64 0, metadata !1680), !dbg !1682 ; [debug line = 10:129@7:0] [debug variable = fabric_interrupt_write_finished.V]
  call void (...)* @_ssdm_op_SpecWire(i1* %controller_finished.V, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1683 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecWire(i1* %fabric_interrupt_write_finished.V, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1684 ; [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecWire(i1* %fabric_interrupt_read_finished.V, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1685 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecWire(i1* %reset_scanner, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1686 ; [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %dma_address, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1687 ; [debug line = 16:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %dma_status, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1688 ; [debug line = 18:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %dma_control, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1689 ; [debug line = 20:1]
  call void (...)* @_ssdm_op_SpecWire(i1 %enabled, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1690 ; [debug line = 22:1]
  call void (...)* @_ssdm_op_SpecWire(i32 %iterations, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1691 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecWire(i32 %length, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1692 ; [debug line = 26:1]
  call void (...)* @_ssdm_op_SpecWire(i32 %startAddress, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1693 ; [debug line = 28:1]
  call void (...)* @_ssdm_op_SpecWire(i32 0, [8 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !1694 ; [debug line = 30:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %AXI_DMA_SLAVE, [6 x i8]* @.str2, i32 0, i32 0, i32 0, i32 14, [10 x i8]* @.str3, [4 x i8]* @.str4, [1 x i8]* @.str1) nounwind, !dbg !1695 ; [debug line = 32:1]
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  ...
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  call void @llvm.dbg.value(metadata !{i1* %enabled.assign}, i64 0, metadata !1645), !dbg !1696 ; [debug line = 34:29] [debug variable = enabled]
  %localEnabled = load volatile i1* %enabled.assign, align 1, !dbg !1696 ; [#uses=1 type=i1] [debug line = 34:29]
  call void @llvm.dbg.value(metadata !{i1 %localEnabled}, i64 0, metadata !1697), !dbg !1696 ; [debug line = 34:29] [debug variable = localEnabled]
  br i1 %localEnabled, label %1, label %._crit_edge, !dbg !1698 ; [debug line = 37:2]

; <label>:1                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %write.assign}, i64 0, metadata !1639), !dbg !1699 ; [debug line = 38:3] [debug variable = write]
  %write.assign.load = load volatile i1* %write.assign, align 1, !dbg !1699 ; [#uses=1 type=i1] [debug line = 38:3]
  br i1 %write.assign.load, label %2, label %11, !dbg !1699 ; [debug line = 38:3]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  ...
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1701 ; [debug line = 40:40] [debug variable = startAddress]
  %localAddress = load volatile i32* %startAddress.assign, align 4, !dbg !1701 ; [#uses=1 type=i32] [debug line = 40:40]
  call void @llvm.dbg.value(metadata !{i32 %localAddress}, i64 0, metadata !1703), !dbg !1701 ; [debug line = 40:40] [debug variable = localAddress]
  store volatile i1 true, i1* %reset_scanner, align 1, !dbg !1704 ; [debug line = 41:4]
  store volatile i1 false, i1* %reset_scanner, align 1, !dbg !1705 ; [debug line = 42:4]
  %AXI_DMA_SLAVE.addr = getelementptr inbounds i32* %AXI_DMA_SLAVE, i64 1, !dbg !1706 ; [#uses=2 type=i32*] [debug line = 56:5]
  %AXI_DMA_SLAVE.addr.1 = getelementptr inbounds i32* %AXI_DMA_SLAVE, i64 6, !dbg !1709 ; [#uses=1 type=i32*] [debug line = 59:5]
  %AXI_DMA_SLAVE.addr.2 = getelementptr inbounds i32* %AXI_DMA_SLAVE, i64 10, !dbg !1710 ; [#uses=1 type=i32*] [debug line = 62:5]
  br label %3, !dbg !1711                         ; [debug line = 43:8]

; <label>:3                                       ; preds = %10, %2
  %i = phi i32 [ 0, %2 ], [ %i.1, %10 ]           ; [#uses=2 type=i32]
  %localAddress1 = phi i32 [ %localAddress, %2 ], [ %localAddress.1, %10 ] ; [#uses=3 type=i32]
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  ...
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  call void @llvm.dbg.value(metadata !{i32* %iterations.assign}, i64 0, metadata !1643), !dbg !1711 ; [debug line = 43:8] [debug variable = iterations]
  %iterations.assign.load = load volatile i32* %iterations.assign, align 4, !dbg !1711 ; [#uses=1 type=i32] [debug line = 43:8]
  %tmp.2 = icmp slt i32 %i, %iterations.assign.load, !dbg !1711 ; [#uses=1 type=i1] [debug line = 43:8]
  br i1 %tmp.2, label %4, label %.loopexit, !dbg !1711 ; [debug line = 43:8]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i1* %controller_finished.V}, i64 0, metadata !1712), !dbg !1714 ; [debug line = 217:49@44:5] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  store volatile i1 false, i1* %controller_finished.V, align 1, !dbg !1716 ; [debug line = 218:10@44:5]
  store volatile i32 4, i32* %AXI_DMA_SLAVE, align 4, !dbg !1718 ; [debug line = 46:5]
  br label %5, !dbg !1719                         ; [debug line = 47:5]

; <label>:5                                       ; preds = %6, %4
  %AXI_DMA_SLAVE.load.2 = load volatile i32* %AXI_DMA_SLAVE, align 4, !dbg !1719 ; [#uses=1 type=i32] [debug line = 47:5]
  %AXI_DMA_SLAVE.load.2.cast = trunc i32 %AXI_DMA_SLAVE.load.2 to i3, !dbg !1719 ; [#uses=1 type=i3] [debug line = 47:5]
  %tmp.4 = icmp sgt i3 %AXI_DMA_SLAVE.load.2.cast, -1, !dbg !1719 ; [#uses=1 type=i1] [debug line = 47:5]
  br i1 %tmp.4, label %7, label %6, !dbg !1719    ; [debug line = 47:5]

; <label>:6                                       ; preds = %5
  store volatile i32 0, i32* %AXI_DMA_SLAVE, align 4, !dbg !1720 ; [debug line = 48:6]
  br label %5, !dbg !1722                         ; [debug line = 49:5]

; <label>:7                                       ; preds = %5
  %AXI_DMA_SLAVE.load.3 = load volatile i32* %AXI_DMA_SLAVE, align 4, !dbg !1723 ; [#uses=1 type=i32] [debug line = 52:5]
  %tmp.5 = or i32 %AXI_DMA_SLAVE.load.3, 1, !dbg !1723 ; [#uses=1 type=i32] [debug line = 52:5]
  store volatile i32 %tmp.5, i32* %AXI_DMA_SLAVE, align 4, !dbg !1723 ; [debug line = 52:5]
  %AXI_DMA_SLAVE.load.4 = load volatile i32* %AXI_DMA_SLAVE, align 4, !dbg !1724 ; [#uses=1 type=i32] [debug line = 54:5]
  %tmp.6 = or i32 %AXI_DMA_SLAVE.load.4, 4096, !dbg !1724 ; [#uses=1 type=i32] [debug line = 54:5]
  store volatile i32 %tmp.6, i32* %AXI_DMA_SLAVE, align 4, !dbg !1724 ; [debug line = 54:5]
  %AXI_DMA_SLAVE.load.5 = load volatile i32* %AXI_DMA_SLAVE, align 4, !dbg !1725 ; [#uses=1 type=i32] [debug line = 55:5]
  store volatile i32 %AXI_DMA_SLAVE.load.5, i32* %dma_control, align 4, !dbg !1725 ; [debug line = 55:5]
  %AXI_DMA_SLAVE.load.6 = load volatile i32* %AXI_DMA_SLAVE.addr, align 4, !dbg !1706 ; [#uses=1 type=i32] [debug line = 56:5]
  store volatile i32 %AXI_DMA_SLAVE.load.6, i32* %dma_status, align 4, !dbg !1706 ; [debug line = 56:5]
  store volatile i32 %localAddress1, i32* %AXI_DMA_SLAVE.addr.1, align 4, !dbg !1709 ; [debug line = 59:5]
  store volatile i32 %localAddress1, i32* %dma_address, align 4, !dbg !1726 ; [debug line = 60:5]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  ...
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1710 ; [debug line = 62:5] [debug variable = length]
  %length.assign.load.1 = load volatile i32* %length.assign, align 4, !dbg !1710 ; [#uses=1 type=i32] [debug line = 62:5]
  store volatile i32 %length.assign.load.1, i32* %AXI_DMA_SLAVE.addr.2, align 4, !dbg !1710 ; [debug line = 62:5]
  %AXI_DMA_SLAVE.load.7 = load volatile i32* %AXI_DMA_SLAVE, align 4, !dbg !1727 ; [#uses=1 type=i32] [debug line = 63:5]
  store volatile i32 %AXI_DMA_SLAVE.load.7, i32* %dma_control, align 4, !dbg !1727 ; [debug line = 63:5]
  %AXI_DMA_SLAVE.load.8 = load volatile i32* %AXI_DMA_SLAVE.addr, align 4, !dbg !1728 ; [#uses=1 type=i32] [debug line = 64:5]
  store volatile i32 %AXI_DMA_SLAVE.load.8, i32* %dma_status, align 4, !dbg !1728 ; [debug line = 64:5]
  %localAddress.1 = add i32 %localAddress1, 4, !dbg !1729 ; [#uses=1 type=i32] [debug line = 65:5]
  call void @llvm.dbg.value(metadata !{i32 %localAddress.1}, i64 0, metadata !1703), !dbg !1729 ; [debug line = 65:5] [debug variable = localAddress]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_read_finished.V}, i64 0, metadata !1730), !dbg !1733 ; [debug line = 41:82@67:54] [debug variable = op.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_read_finished.V}, i64 0, metadata !1735), !dbg !1737 ; [debug line = 41:82@41:103@67:54] [debug variable = op.V]
  %local.V.2 = load volatile i1* %fabric_interrupt_read_finished.V, align 1, !dbg !1739 ; [#uses=1 type=i1] [debug line = 41:88@41:103@67:54]
  call void @llvm.dbg.value(metadata !{i1 %local.V.2}, i64 0, metadata !1741), !dbg !1739 ; [debug line = 41:88@41:103@67:54] [debug variable = local.V]
  br label %8, !dbg !1749                         ; [debug line = 76:5]

; <label>:8                                       ; preds = %9, %7
  %__Val2__ = phi i1 [ %local.V.2, %7 ], [ %local.V.3, %9 ] ; [#uses=1 type=i1]
  call void @llvm.dbg.value(metadata !{i1 %__Val2__}, i64 0, metadata !1750), !dbg !1753 ; [debug line = 1623:163@76:12] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i1 %__Val2__}, i64 0, metadata !1755), !dbg !1756 ; [debug line = 1623:165@76:12] [debug variable = __Result__]
  br i1 %__Val2__, label %10, label %9, !dbg !1754 ; [debug line = 76:12]

; <label>:9                                       ; preds = %8
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_read_finished.V}, i64 0, metadata !1730), !dbg !1757 ; [debug line = 41:82@77:6] [debug variable = op.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_read_finished.V}, i64 0, metadata !1735), !dbg !1760 ; [debug line = 41:82@41:103@77:6] [debug variable = op.V]
  %local.V.3 = load volatile i1* %fabric_interrupt_read_finished.V, align 1, !dbg !1762 ; [#uses=1 type=i1] [debug line = 41:88@41:103@77:6]
  call void @llvm.dbg.value(metadata !{i1 %local.V.3}, i64 0, metadata !1741), !dbg !1763 ; [debug line = 126:10@77:6] [debug variable = local.V]
  br label %8, !dbg !1765                         ; [debug line = 79:5]

; <label>:10                                      ; preds = %8
  call void @llvm.dbg.value(metadata !{i1* %controller_finished.V}, i64 0, metadata !1712), !dbg !1766 ; [debug line = 217:49@80:5] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  store volatile i1 true, i1* %controller_finished.V, align 1, !dbg !1768 ; [debug line = 218:10@80:5]
  %i.1 = add nsw i32 %i, 1, !dbg !1769            ; [#uses=1 type=i32] [debug line = 43:29]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !1770), !dbg !1769 ; [debug line = 43:29] [debug variable = i]
  br label %3, !dbg !1769                         ; [debug line = 43:29]

; <label>:11                                      ; preds = %1
  %AXI_DMA_SLAVE.addr.3 = getelementptr inbounds i32* %AXI_DMA_SLAVE, i64 12, !dbg !1771 ; [#uses=4 type=i32*] [debug line = 86:4]
  %AXI_DMA_SLAVE.load = load volatile i32* %AXI_DMA_SLAVE.addr.3, align 4, !dbg !1771 ; [#uses=1 type=i32] [debug line = 86:4]
  %tmp = or i32 %AXI_DMA_SLAVE.load, 1, !dbg !1771 ; [#uses=1 type=i32] [debug line = 86:4]
  store volatile i32 %tmp, i32* %AXI_DMA_SLAVE.addr.3, align 4, !dbg !1771 ; [debug line = 86:4]
  %AXI_DMA_SLAVE.load.1 = load volatile i32* %AXI_DMA_SLAVE.addr.3, align 4, !dbg !1773 ; [#uses=1 type=i32] [debug line = 88:4]
  %tmp.1 = or i32 %AXI_DMA_SLAVE.load.1, 4096, !dbg !1773 ; [#uses=1 type=i32] [debug line = 88:4]
  store volatile i32 %tmp.1, i32* %AXI_DMA_SLAVE.addr.3, align 4, !dbg !1773 ; [debug line = 88:4]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  ...
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  call void @llvm.dbg.value(metadata !{i32* %startAddress.assign}, i64 0, metadata !1637), !dbg !1774 ; [debug line = 90:4] [debug variable = startAddress]
  %startAddress.assign.load = load volatile i32* %startAddress.assign, align 4, !dbg !1774 ; [#uses=1 type=i32] [debug line = 90:4]
  %AXI_DMA_SLAVE.addr.4 = getelementptr inbounds i32* %AXI_DMA_SLAVE, i64 18, !dbg !1774 ; [#uses=1 type=i32*] [debug line = 90:4]
  store volatile i32 %startAddress.assign.load, i32* %AXI_DMA_SLAVE.addr.4, align 4, !dbg !1774 ; [debug line = 90:4]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  ...
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  call void @llvm.dbg.value(metadata !{i32* %length.assign}, i64 0, metadata !1641), !dbg !1775 ; [debug line = 92:4] [debug variable = length]
  %length.assign.load = load volatile i32* %length.assign, align 4, !dbg !1775 ; [#uses=1 type=i32] [debug line = 92:4]
  %AXI_DMA_SLAVE.addr.5 = getelementptr inbounds i32* %AXI_DMA_SLAVE, i64 22, !dbg !1775 ; [#uses=1 type=i32*] [debug line = 92:4]
  store volatile i32 %length.assign.load, i32* %AXI_DMA_SLAVE.addr.5, align 4, !dbg !1775 ; [debug line = 92:4]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_write_finished.V}, i64 0, metadata !1730), !dbg !1776 ; [debug line = 41:82@95:54] [debug variable = op.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_write_finished.V}, i64 0, metadata !1735), !dbg !1778 ; [debug line = 41:82@41:103@95:54] [debug variable = op.V]
  %local.V = load volatile i1* %fabric_interrupt_write_finished.V, align 1, !dbg !1780 ; [#uses=1 type=i1] [debug line = 41:88@41:103@95:54]
  call void @llvm.dbg.value(metadata !{i1 %local.V}, i64 0, metadata !1781), !dbg !1780 ; [debug line = 41:88@41:103@95:54] [debug variable = local.V]
  br label %12, !dbg !1783                        ; [debug line = 97:4]

; <label>:12                                      ; preds = %13, %11
  %__Val2__.2 = phi i1 [ %local.V, %11 ], [ %local.V.1, %13 ] ; [#uses=1 type=i1]
  call void @llvm.dbg.value(metadata !{i1 %__Val2__.2}, i64 0, metadata !1750), !dbg !1784 ; [debug line = 1623:163@97:11] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i1 %__Val2__.2}, i64 0, metadata !1755), !dbg !1786 ; [debug line = 1623:165@97:11] [debug variable = __Result__]
  br i1 %__Val2__.2, label %14, label %13, !dbg !1785 ; [debug line = 97:11]

; <label>:13                                      ; preds = %12
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_write_finished.V}, i64 0, metadata !1730), !dbg !1787 ; [debug line = 41:82@98:5] [debug variable = op.V]
  call void @llvm.dbg.value(metadata !{i1* %fabric_interrupt_write_finished.V}, i64 0, metadata !1735), !dbg !1790 ; [debug line = 41:82@41:103@98:5] [debug variable = op.V]
  %local.V.1 = load volatile i1* %fabric_interrupt_write_finished.V, align 1, !dbg !1792 ; [#uses=1 type=i1] [debug line = 41:88@41:103@98:5]
  call void @llvm.dbg.value(metadata !{i1 %local.V.1}, i64 0, metadata !1781), !dbg !1793 ; [debug line = 126:10@98:5] [debug variable = local.V]
  br label %12, !dbg !1794                        ; [debug line = 100:4]

; <label>:14                                      ; preds = %12
  call void @llvm.dbg.value(metadata !{i1* %controller_finished.V}, i64 0, metadata !1712), !dbg !1795 ; [debug line = 217:49@101:4] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  store volatile i1 true, i1* %controller_finished.V, align 1, !dbg !1797 ; [debug line = 218:10@101:4]
  br label %.loopexit

.loopexit:                                        ; preds = %14, %3
  br label %._crit_edge, !dbg !1798               ; [debug line = 107:2]

._crit_edge:                                      ; preds = %.loopexit, %0
  ret void, !dbg !1799                            ; [debug line = 109:1]
}
...
!1572 = metadata !{metadata !1573, [1 x i32]* @llvm.global_ctors.0}
!1573 = metadata !{metadata !1574}
!1574 = metadata !{i32 0, i32 31, metadata !1575}
!1575 = metadata !{metadata !1576}
!1576 = metadata !{metadata !"llvm.global_ctors.0", metadata !1577, metadata !""}
!1577 = metadata !{metadata !1578}
!1578 = metadata !{i32 0, i32 0, i32 1}
!1579 = metadata !{metadata !1580}
!1580 = metadata !{i32 0, i32 31, metadata !1581}
!1581 = metadata !{metadata !1582}
!1582 = metadata !{metadata !"AXI_DMA_SLAVE", metadata !1583, metadata !"int"}
!1583 = metadata !{metadata !1584}
!1584 = metadata !{i32 0, i32 13, i32 1}
!1585 = metadata !{metadata !1586}
!1586 = metadata !{i32 0, i32 31, metadata !1587}
!1587 = metadata !{metadata !1588}
!1588 = metadata !{metadata !"startAddress", metadata !1589, metadata !"unsigned int"}
!1589 = metadata !{metadata !1590}
!1590 = metadata !{i32 0, i32 0, i32 0}
!1591 = metadata !{metadata !1592}
!1592 = metadata !{i32 0, i32 0, metadata !1593}
!1593 = metadata !{metadata !1594}
!1594 = metadata !{metadata !"write", metadata !1589, metadata !"bool"}
!1595 = metadata !{metadata !1596}
!1596 = metadata !{i32 0, i32 31, metadata !1597}
!1597 = metadata !{metadata !1598}
!1598 = metadata !{metadata !"length", metadata !1589, metadata !"int"}
!1599 = metadata !{metadata !1600}
!1600 = metadata !{i32 0, i32 31, metadata !1601}
!1601 = metadata !{metadata !1602}
!1602 = metadata !{metadata !"iterations", metadata !1589, metadata !"int"}
!1603 = metadata !{metadata !1604}
!1604 = metadata !{i32 0, i32 0, metadata !1605}
!1605 = metadata !{metadata !1606}
!1606 = metadata !{metadata !"enabled", metadata !1589, metadata !"bool"}
!1607 = metadata !{metadata !1608}
!1608 = metadata !{i32 0, i32 0, metadata !1609}
!1609 = metadata !{metadata !1610}
!1610 = metadata !{metadata !"reset_scanner", metadata !1577, metadata !"bool"}
!1611 = metadata !{metadata !1612}
!1612 = metadata !{i32 0, i32 31, metadata !1613}
!1613 = metadata !{metadata !1614}
!1614 = metadata !{metadata !"dma_control", metadata !1577, metadata !"int"}
!1615 = metadata !{metadata !1616}
!1616 = metadata !{i32 0, i32 31, metadata !1617}
!1617 = metadata !{metadata !1618}
!1618 = metadata !{metadata !"dma_status", metadata !1577, metadata !"int"}
!1619 = metadata !{metadata !1620}
!1620 = metadata !{i32 0, i32 31, metadata !1621}
!1621 = metadata !{metadata !1622}
!1622 = metadata !{metadata !"dma_address", metadata !1577, metadata !"int"}
!1623 = metadata !{metadata !1624}
!1624 = metadata !{i32 0, i32 0, metadata !1625}
!1625 = metadata !{metadata !1626}
!1626 = metadata !{metadata !"fabric_interrupt_write_finished.V", metadata !1577, metadata !"uint1"}
!1627 = metadata !{metadata !1628}
!1628 = metadata !{i32 0, i32 0, metadata !1629}
!1629 = metadata !{metadata !1630}
!1630 = metadata !{metadata !"fabric_interrupt_read_finished.V", metadata !1577, metadata !"uint1"}
!1631 = metadata !{metadata !1632}
!1632 = metadata !{i32 0, i32 0, metadata !1633}
!1633 = metadata !{metadata !1634}
!1634 = metadata !{metadata !"controller_finished.V", metadata !1577, metadata !"uint1"}
!1635 = metadata !{i32 786689, metadata !839, metadata !"AXI_DMA_SLAVE", metadata !840, i32 16777220, metadata !844, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1636 = metadata !{i32 4, i32 51, metadata !839, null}
!1637 = metadata !{i32 786689, metadata !839, metadata !"startAddress", metadata !840, i32 33554436, metadata !846, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1638 = metadata !{i32 4, i32 84, metadata !839, null}
!1639 = metadata !{i32 786689, metadata !839, metadata !"write", metadata !840, i32 50331652, metadata !848, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1640 = metadata !{i32 4, i32 112, metadata !839, null}
!1641 = metadata !{i32 786689, metadata !839, metadata !"length", metadata !840, i32 67108868, metadata !845, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1642 = metadata !{i32 4, i32 132, metadata !839, null}
!1643 = metadata !{i32 786689, metadata !839, metadata !"iterations", metadata !840, i32 83886085, metadata !845, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1644 = metadata !{i32 5, i32 16, metadata !839, null}
!1645 = metadata !{i32 786689, metadata !839, metadata !"enabled", metadata !840, i32 100663301, metadata !848, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1646 = metadata !{i32 5, i32 42, metadata !839, null}
!1647 = metadata !{i32 786689, metadata !839, metadata !"reset_scanner", metadata !840, i32 117440517, metadata !849, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1648 = metadata !{i32 5, i32 66, metadata !839, null}
!1649 = metadata !{i32 786689, metadata !839, metadata !"dma_control", metadata !840, i32 134217734, metadata !844, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1650 = metadata !{i32 6, i32 17, metadata !839, null}
!1651 = metadata !{i32 786689, metadata !839, metadata !"dma_status", metadata !840, i32 150994950, metadata !844, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1652 = metadata !{i32 6, i32 44, metadata !839, null}
!1653 = metadata !{i32 786689, metadata !839, metadata !"dma_address", metadata !840, i32 167772166, metadata !844, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1654 = metadata !{i32 6, i32 70, metadata !839, null}
!1655 = metadata !{i32 790531, metadata !1656, metadata !"fabric_interrupt_write_finished.V", null, i32 7, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1656 = metadata !{i32 786689, metadata !839, metadata !"fabric_interrupt_write_finished", metadata !840, i32 184549383, metadata !850, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1657 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !1658} ; [ DW_TAG_pointer_type ]
!1658 = metadata !{i32 786438, null, metadata !"ap_uint<1>", metadata !853, i32 134, i64 1, i64 8, i32 0, i32 0, null, metadata !1659, i32 0, null, metadata !1150} ; [ DW_TAG_class_field_type ]
!1659 = metadata !{metadata !1660}
!1660 = metadata !{i32 786438, null, metadata !"ap_int_base<1, false, true>", metadata !829, i32 1302, i64 1, i64 8, i32 0, i32 0, null, metadata !1661, i32 0, null, metadata !1078} ; [ DW_TAG_class_field_type ]
!1661 = metadata !{metadata !1662}
!1662 = metadata !{i32 786438, null, metadata !"ssdm_int<1 + 1024 * 0, false>", metadata !860, i32 3, i64 1, i64 8, i32 0, i32 0, null, metadata !1663, i32 0, null, metadata !868} ; [ DW_TAG_class_field_type ]
!1663 = metadata !{metadata !862}
!1664 = metadata !{i32 7, i32 24, metadata !839, null}
!1665 = metadata !{i32 790531, metadata !1666, metadata !"fabric_interrupt_read_finished.V", null, i32 7, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1666 = metadata !{i32 786689, metadata !839, metadata !"fabric_interrupt_read_finished", metadata !840, i32 201326599, metadata !1151, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1667 = metadata !{i32 7, i32 78, metadata !839, null}
!1668 = metadata !{i32 790531, metadata !1669, metadata !"controller_finished.V", null, i32 7, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1669 = metadata !{i32 786689, metadata !839, metadata !"controller_finished", metadata !840, i32 218103815, metadata !1151, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1670 = metadata !{i32 7, i32 131, metadata !839, null}
!1671 = metadata !{i32 790531, metadata !1672, metadata !"controller_finished.V", null, i32 46, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1672 = metadata !{i32 786689, metadata !1499, metadata !"controller_finished", metadata !840, i32 16777262, metadata !1151, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1673 = metadata !{i32 46, i32 117, metadata !1499, metadata !1674}
!1674 = metadata !{i32 7, i32 152, metadata !1675, null}
!1675 = metadata !{i32 786443, metadata !839, i32 7, i32 151, metadata !840, i32 0} ; [ DW_TAG_lexical_block ]
!1676 = metadata !{i32 790531, metadata !1677, metadata !"fabric_interrupt_read_finished.V", null, i32 28, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1677 = metadata !{i32 786689, metadata !1487, metadata !"fabric_interrupt_read_finished", metadata !840, i32 16777244, metadata !1151, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1678 = metadata !{i32 28, i32 128, metadata !1487, metadata !1679}
!1679 = metadata !{i32 7, i32 0, metadata !1675, null}
!1680 = metadata !{i32 790531, metadata !1681, metadata !"fabric_interrupt_write_finished.V", null, i32 10, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1681 = metadata !{i32 786689, metadata !1467, metadata !"fabric_interrupt_write_finished", metadata !840, i32 16777226, metadata !1151, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1682 = metadata !{i32 10, i32 129, metadata !1467, metadata !1679}
!1683 = metadata !{i32 8, i32 1, metadata !1675, null}
!1684 = metadata !{i32 10, i32 1, metadata !1675, null}
!1685 = metadata !{i32 12, i32 1, metadata !1675, null}
!1686 = metadata !{i32 14, i32 1, metadata !1675, null}
!1687 = metadata !{i32 16, i32 1, metadata !1675, null}
!1688 = metadata !{i32 18, i32 1, metadata !1675, null}
!1689 = metadata !{i32 20, i32 1, metadata !1675, null}
!1690 = metadata !{i32 22, i32 1, metadata !1675, null}
!1691 = metadata !{i32 24, i32 1, metadata !1675, null}
!1692 = metadata !{i32 26, i32 1, metadata !1675, null}
!1693 = metadata !{i32 28, i32 1, metadata !1675, null}
!1694 = metadata !{i32 30, i32 1, metadata !1675, null}
!1695 = metadata !{i32 32, i32 1, metadata !1675, null}
!1696 = metadata !{i32 34, i32 29, metadata !1675, null}
!1697 = metadata !{i32 786688, metadata !1675, metadata !"localEnabled", metadata !840, i32 34, metadata !219, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1698 = metadata !{i32 37, i32 2, metadata !1675, null}
!1699 = metadata !{i32 38, i32 3, metadata !1700, null}
!1700 = metadata !{i32 786443, metadata !1675, i32 37, i32 18, metadata !840, i32 1} ; [ DW_TAG_lexical_block ]
!1701 = metadata !{i32 40, i32 40, metadata !1702, null}
!1702 = metadata !{i32 786443, metadata !1700, i32 38, i32 12, metadata !840, i32 2} ; [ DW_TAG_lexical_block ]
!1703 = metadata !{i32 786688, metadata !1702, metadata !"localAddress", metadata !840, i32 40, metadata !847, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1704 = metadata !{i32 41, i32 4, metadata !1702, null}
!1705 = metadata !{i32 42, i32 4, metadata !1702, null}
!1706 = metadata !{i32 56, i32 5, metadata !1707, null}
!1707 = metadata !{i32 786443, metadata !1708, i32 43, i32 33, metadata !840, i32 4} ; [ DW_TAG_lexical_block ]
!1708 = metadata !{i32 786443, metadata !1702, i32 43, i32 4, metadata !840, i32 3} ; [ DW_TAG_lexical_block ]
!1709 = metadata !{i32 59, i32 5, metadata !1707, null}
!1710 = metadata !{i32 62, i32 5, metadata !1707, null}
!1711 = metadata !{i32 43, i32 8, metadata !1708, null}
!1712 = metadata !{i32 790531, metadata !1713, metadata !"ssdm_int<1 + 1024 * 0, false>.V", null, i32 217, metadata !1657, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1713 = metadata !{i32 786689, metadata !1466, metadata !"this", metadata !853, i32 16777433, metadata !850, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!1714 = metadata !{i32 217, i32 49, metadata !1466, metadata !1715}
!1715 = metadata !{i32 44, i32 5, metadata !1707, null}
!1716 = metadata !{i32 218, i32 10, metadata !1717, metadata !1715}
!1717 = metadata !{i32 786443, metadata !1466, i32 217, i32 97, metadata !853, i32 19} ; [ DW_TAG_lexical_block ]
!1718 = metadata !{i32 46, i32 5, metadata !1707, null}
!1719 = metadata !{i32 47, i32 5, metadata !1707, null}
!1720 = metadata !{i32 48, i32 6, metadata !1721, null}
!1721 = metadata !{i32 786443, metadata !1707, i32 47, i32 32, metadata !840, i32 5} ; [ DW_TAG_lexical_block ]
!1722 = metadata !{i32 49, i32 5, metadata !1721, null}
!1723 = metadata !{i32 52, i32 5, metadata !1707, null}
!1724 = metadata !{i32 54, i32 5, metadata !1707, null}
!1725 = metadata !{i32 55, i32 5, metadata !1707, null}
!1726 = metadata !{i32 60, i32 5, metadata !1707, null}
!1727 = metadata !{i32 63, i32 5, metadata !1707, null}
!1728 = metadata !{i32 64, i32 5, metadata !1707, null}
!1729 = metadata !{i32 65, i32 5, metadata !1707, null}
!1730 = metadata !{i32 790531, metadata !1731, metadata !"op.V", null, i32 41, metadata !1732, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1731 = metadata !{i32 786689, metadata !1460, metadata !"op", metadata !853, i32 33554473, metadata !1087, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1732 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !1658} ; [ DW_TAG_pointer_type ]
!1733 = metadata !{i32 41, i32 82, metadata !1460, metadata !1734}
!1734 = metadata !{i32 67, i32 54, metadata !1707, null}
!1735 = metadata !{i32 790531, metadata !1736, metadata !"op.V", null, i32 41, metadata !1732, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!1736 = metadata !{i32 786689, metadata !1461, metadata !"op", metadata !853, i32 33554473, metadata !1087, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!1737 = metadata !{i32 41, i32 82, metadata !1461, metadata !1738}
!1738 = metadata !{i32 41, i32 103, metadata !1460, metadata !1734}
!1739 = metadata !{i32 41, i32 88, metadata !1740, metadata !1738}
!1740 = metadata !{i32 786443, metadata !1461, i32 41, i32 86, metadata !853, i32 15} ; [ DW_TAG_lexical_block ]
!1741 = metadata !{i32 790529, metadata !1742, metadata !"local.V", null, i32 67, metadata !1743, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!1742 = metadata !{i32 786688, metadata !1707, metadata !"local", metadata !840, i32 67, metadata !1160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1743 = metadata !{i32 786438, null, metadata !"ap_int<1>", metadata !853, i32 27, i64 1, i64 8, i32 0, i32 0, null, metadata !1744, i32 0, null, metadata !1150} ; [ DW_TAG_class_field_type ]
!1744 = metadata !{metadata !1745}
!1745 = metadata !{i32 786438, null, metadata !"ap_int_base<1, true, true>", metadata !829, i32 1302, i64 1, i64 8, i32 0, i32 0, null, metadata !1746, i32 0, null, metadata !1381} ; [ DW_TAG_class_field_type ]
!1746 = metadata !{metadata !1747}
!1747 = metadata !{i32 786438, null, metadata !"ssdm_int<1 + 1024 * 0, true>", metadata !860, i32 3, i64 1, i64 8, i32 0, i32 0, null, metadata !1748, i32 0, null, metadata !1179} ; [ DW_TAG_class_field_type ]
!1748 = metadata !{metadata !1168}
!1749 = metadata !{i32 76, i32 5, metadata !1707, null}
!1750 = metadata !{i32 786688, metadata !1751, metadata !"__Val2__", metadata !829, i32 1623, metadata !1169, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1751 = metadata !{i32 786443, metadata !1752, i32 1623, i32 17, metadata !829, i32 14} ; [ DW_TAG_lexical_block ]
!1752 = metadata !{i32 786443, metadata !1459, i32 1621, i32 67, metadata !829, i32 13} ; [ DW_TAG_lexical_block ]
!1753 = metadata !{i32 1623, i32 163, metadata !1751, metadata !1754}
!1754 = metadata !{i32 76, i32 12, metadata !1707, null}
!1755 = metadata !{i32 786688, metadata !1751, metadata !"__Result__", metadata !829, i32 1623, metadata !1169, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1756 = metadata !{i32 1623, i32 165, metadata !1751, metadata !1754}
!1757 = metadata !{i32 41, i32 82, metadata !1460, metadata !1758}
!1758 = metadata !{i32 77, i32 6, metadata !1759, null}
!1759 = metadata !{i32 786443, metadata !1707, i32 76, i32 26, metadata !840, i32 6} ; [ DW_TAG_lexical_block ]
!1760 = metadata !{i32 41, i32 82, metadata !1461, metadata !1761}
!1761 = metadata !{i32 41, i32 103, metadata !1460, metadata !1758}
!1762 = metadata !{i32 41, i32 88, metadata !1740, metadata !1761}
!1763 = metadata !{i32 126, i32 10, metadata !1764, metadata !1758}
!1764 = metadata !{i32 786443, metadata !1156, i32 125, i32 90, metadata !853, i32 12} ; [ DW_TAG_lexical_block ]
!1765 = metadata !{i32 79, i32 5, metadata !1759, null}
!1766 = metadata !{i32 217, i32 49, metadata !1466, metadata !1767}
!1767 = metadata !{i32 80, i32 5, metadata !1707, null}
!1768 = metadata !{i32 218, i32 10, metadata !1717, metadata !1767}
!1769 = metadata !{i32 43, i32 29, metadata !1708, null}
!1770 = metadata !{i32 786688, metadata !1702, metadata !"i", metadata !840, i32 39, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1771 = metadata !{i32 86, i32 4, metadata !1772, null}
!1772 = metadata !{i32 786443, metadata !1700, i32 84, i32 9, metadata !840, i32 7} ; [ DW_TAG_lexical_block ]
!1773 = metadata !{i32 88, i32 4, metadata !1772, null}
!1774 = metadata !{i32 90, i32 4, metadata !1772, null}
!1775 = metadata !{i32 92, i32 4, metadata !1772, null}
!1776 = metadata !{i32 41, i32 82, metadata !1460, metadata !1777}
!1777 = metadata !{i32 95, i32 54, metadata !1772, null}
!1778 = metadata !{i32 41, i32 82, metadata !1461, metadata !1779}
!1779 = metadata !{i32 41, i32 103, metadata !1460, metadata !1777}
!1780 = metadata !{i32 41, i32 88, metadata !1740, metadata !1779}
!1781 = metadata !{i32 790529, metadata !1782, metadata !"local.V", null, i32 95, metadata !1743, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!1782 = metadata !{i32 786688, metadata !1772, metadata !"local", metadata !840, i32 95, metadata !1160, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!1783 = metadata !{i32 97, i32 4, metadata !1772, null}
!1784 = metadata !{i32 1623, i32 163, metadata !1751, metadata !1785}
!1785 = metadata !{i32 97, i32 11, metadata !1772, null}
!1786 = metadata !{i32 1623, i32 165, metadata !1751, metadata !1785}
!1787 = metadata !{i32 41, i32 82, metadata !1460, metadata !1788}
!1788 = metadata !{i32 98, i32 5, metadata !1789, null}
!1789 = metadata !{i32 786443, metadata !1772, i32 97, i32 25, metadata !840, i32 8} ; [ DW_TAG_lexical_block ]
!1790 = metadata !{i32 41, i32 82, metadata !1461, metadata !1791}
!1791 = metadata !{i32 41, i32 103, metadata !1460, metadata !1788}
!1792 = metadata !{i32 41, i32 88, metadata !1740, metadata !1791}
!1793 = metadata !{i32 126, i32 10, metadata !1764, metadata !1788}
!1794 = metadata !{i32 100, i32 4, metadata !1789, null}
!1795 = metadata !{i32 217, i32 49, metadata !1466, metadata !1796}
!1796 = metadata !{i32 101, i32 4, metadata !1772, null}
!1797 = metadata !{i32 218, i32 10, metadata !1717, metadata !1796}
!1798 = metadata !{i32 107, i32 2, metadata !1700, null}
!1799 = metadata !{i32 109, i32 1, metadata !1675, null}
