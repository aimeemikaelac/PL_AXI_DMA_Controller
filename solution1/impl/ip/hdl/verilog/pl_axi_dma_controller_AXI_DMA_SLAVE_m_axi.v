...
module pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
...
//------------------------Instantiation------------------
// pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_write
pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_write #(
...
// pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_read
pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_read #(
    .C_ID_WIDTH        ( C_ID_WIDTH ),
    .C_ADDR_WIDTH      ( C_ADDR_WIDTH ),
    .C_TARGET_ADDR     ( C_TARGET_ADDR ),
...
module pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
...
module pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_read
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Instantiation------------------
// pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_read_data_align 
pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_read_data_align #(
    .C_DATA_WIDTH       (C_DATA_WIDTH),
...
pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_fifo  #(
...
module pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_read_data_align
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_reg_slice
...
module pl_axi_dma_controller_AXI_DMA_SLAVE_m_axi_write
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
